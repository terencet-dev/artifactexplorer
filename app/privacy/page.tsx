    ...
    <div className="container mx-auto max-w-4xl py-8 px-4">
      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
        <div className="prose max-w-none dark:prose-invert">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            All analytics data is stored securely by trusted third-party services (like Microsoft Clarity) in accordance with their data handling policies. We do not store sensitive or identifiable information on our own servers.
          </p>
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            By using Artifact Explorer, you agree to Microsoft&rsquo;s collection and use of your data as described in their{' '}
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-100">6. Data Security</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-100">7. Your Rights</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-100">8. Children&rsquo;s Privacy</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-100">9. Changes to This Policy</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800 dark:text-gray-100">10. Contact Information</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            For questions or concerns regarding this policy, please contact the admin.
          </p>
        </div>
      </div>
    </div>
